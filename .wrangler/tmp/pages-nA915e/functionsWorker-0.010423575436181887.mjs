...
var wt = K(() => {
  ...
  a(x, "Socket"), T(x, "defaults", {
    ...
    fetchEndpoint: /* @__PURE__ */ __name((t) => "https://" + Ru(t) + "/sql", "fetchEndpoint"),
...
var gs = I((xt) => {
  ...
  var Jr = ys(), F = new Jr.Writer(), Fu = a((r) => {
    ...
    describe: Ku,
    close: Vu,
    flush: /* @__PURE__ */ __name(() => Zu, "flush"),
    sync: /* @__PURE__ */ __name(() => Ju, "sync"),
    end: /* @__PURE__ */ __name(() => Xu, "end"),
    copyData: zu,
    copyDone: /* @__PURE__ */ __name(() => ec, "copyDone"),
    copyFail: Yu,
    cancel: Hu
  };
  xt.serialize = tc;
...
var bs = {};
X(bs, { default: /* @__PURE__ */ __name(() => nc, "default") });
var nc;
var Ss = K(() => {
  "use strict";
  p();
...
var _s = {};
X(_s, { connect: /* @__PURE__ */ __name(() => fc, "connect") });
...
var Os = {};
X(Os, { default: /* @__PURE__ */ __name(() => Ic, "default") });
var Ic;
var ks = K(() => {
  "use strict";
  p();
...
// api/recipes/[id].ts
var onRequestGet2 = /* @__PURE__ */ __name(async ({ params, env }) => {
  try {
    const id = params?.id;
    if (!id) {
...
var onRequestGet4 = /* @__PURE__ */ __name(async ({ params, request, env }) => {
  try {
...
var onRequestGet5 = /* @__PURE__ */ __name(async ({ params, env, request }) => {
  try {
    const date = params?.date;
...
var onRequestGet6 = /* @__PURE__ */ __name(async ({ params, env, request }) => {
  try {
...
// robots.txt.ts
var onRequestGet9 = /* @__PURE__ */ __name(async ({ request }) => {
  try {
...
// ../.wrangler/tmp/pages-nA915e/functionsRoutes-0.44155815140947086.mjs
var routes = [
  {
...
// C:/Users/goovl_bz0be4i/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/goovl_bz0be4i/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-bFN2oO/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-bFN2oO/middleware-loader.entry.ts
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.010423575436181887.mjs.map
