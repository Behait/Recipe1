...
<body class="bg-slate-50 text-slate-800 dark:bg-slate-900 dark:text-slate-100">
  ...
  <main class="max-w-4xl mx-auto px-4 py-6 space-y-6">
    ...
    <div>
      <a class="inline-flex items-center px-3 py-2 rounded-md border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200" href="/recipes/${escapeHtml(recipe.id)}">查看详情 →</a>
    </div>
  </main>
